...
class CNSD_globalSettings{

	static $page_id = "chartnerd_settings";

	static $default_tab = "general_settings";
	    
	    //map tab ids to tab names
	static $tabs = [
	        'general_settings' => "General Settings",
	        'pro_settings' => 'Upgrade to PRO',
	        'stripe_dashboard' => 'Stripe & Paypal settings',
	    ];
	static $available_shortcodes = array(
									'[monthly_recurring_revenue]',
									'[CNSD_customers from="" to=""]',
									'[refunds_monthly month="" year=""]',
	...
	public static function CNSD_getGeneralSettingsStyle(){
		$defalt_option_key = self::$page_id.'_'.self::$default_tab.'_options';
        $options = get_option($defalt_option_key,true);
        $style = '';
...
$CNSD_globalSettings = new CNSD_globalSettings();
